...
//Class USER extends VALIDATION with properties 'email', 'password', 'dateOfBirth', and 'phoneNumber'. Implement a method to validate the user input.
class User extends Validation
{
    ...
    public function validate(): void
    {
        ...
        if ($isValid) {
            echo "User's Credentials are Valid. <br>";
        }
    }
}

// Instantiate the class
$user = new User("John@Does.com", "password", "1999-09-01", "123-456-7890");
